---
title: 'How a Subway franchisee built a 325-application hiring pipeline in three months'
description: 'Grupo DGK, a Subway franchise group operating 24-hour stores in southern Brazil, processed 325 applications with AI-assisted screening and built a 104-person talent pool using Visio Recruitment and Selection.'
...
- **325 job applications** processed in ~3 months (late Oct 2025 to Jan 2026)
- **124 applications in January 2026**, the record month, with 20 in a single day
- **104-person talent pool** built for future hiring needs across 3-4 stores
...
|--------|--------|-------|-------------|
| Total applications (~3 months) | Untracked | 325 | New capability |
| Applications per month (peak) | Untracked | 124 (Jan 2026) | New capability |
| Peak single-day applications | Untracked | 20 (Jan 6, 2026) | New capability |
| Talent pool | None | 104 candidates | New capability |
| Hired through platform | N/A | 3 | New capability |
| Interview preparation | No framework | AI-generated questions per candidate | From guessing to structured |
| Channel visibility | No data | Facebook 62.5%, WhatsApp significant, QR Code 5% | New capability |
| Pipeline visibility | No stages tracked | Full funnel: screening > interview > test > admission | New capability |
