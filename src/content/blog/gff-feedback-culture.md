---
title: 'Fresh Food Group managers go from zero structured feedbacks to 16 per month'
description: 'Fresh Food Group, a food service franchise operating ~47 stores across Brazil, had no structured feedback culture. After deploying Visio Feedback, managers exceeded their goal of one feedback per month by up to 16x, with 114 structured feedbacks registered in February 2026 alone.'
...
- **338 total feedbacks** in 5 months (Oct 2025 to Mar 2026)
- **114 feedbacks in February 2026**, with AI-analyzed quality averaging 4.1/5
- **Top store (Subway Francisco Sales)**: 16 feedbacks from its manager in one month, 4.5/5 employee comprehension score
...
|--------|--------|-------|-------------|
| Structured feedbacks per manager per month | 0 | 1 to 16 (goal: 1) | From zero to 16x goal |
| Total feedbacks (5 months) | 0 | 338 | New capability |
| Monthly feedbacks (Feb 2026) | 0 | 114 | New capability |
| Stores enrolled | 0 | 47 | New capability |
| AI feedback quality score | N/A | 4.1/5 | New metric |
| Employee comprehension score | N/A | 3.9/5 | New metric |
| Consequence explanation accuracy | N/A | 93% | New metric |
